...
export const products = [
  {
    ...
    description: {
      short: "Soft white sandwich bread, perfect for light meals.",
  ...
  },
  {
    ...
    description: {
      short: "Whole grain sandwich bread for a healthy choice.",
  ...
  {
    id: 61,
    name: "Pain De Campagne400g",
    price: 12.5,
    fileName: "pain-de-campagne400g",
    slug: "pain-de-campagne400g",
    description: {
      short: "Country-style bread, 400g.",
  ...
  },
  {
    ...
    description: {
      short: "Traditional whole grain round bread, 100g.",
  ...
  },
  {
    ...
    description: {
      short: "Large whole grain bread without salt.",
  ...
  },
  {
    ...
    description: {
      short: "Mini burger buns for small servings.",
  ...
  },
  {
    ...
    description: {
      short: "Dark mini burger buns for a unique taste.",
  ...
  },
  {
    ...
    slug: "pain-burger",
    description: {
      short: "Classic burger buns for your favorite burgers.",
  ...
  },
  {
    ...
    description: {
      short: "Dark burger buns for a rich flavor.",
  ...
  },
  {
    ...
    slug: "pain-burger-xl",
    description: {
      short: "Extra-large burger buns for big burgers.",
  ...
  },
  {
    ...
    description: {
      short: "Large rustic bread for a hearty meal.",
  ...
  },
  {
    ...
    description: {
      short: "Norwegian-style rustic bread.",
  ...
  },
  {
    ...
    description: {
      short: "Rye rustic bread for a robust flavor.",
  ...
  },
  {
    ...
    slug: "polka-long",
    description: {
      short: "Long polka bread for a unique presentation.",
  ...
  },
  {
    ...
    description: {
      short: "Large sliced bread, 1.5kg.",
  ...
  },
  {
    ...
    description: {
      short: "Chocolate chip cookies for a sweet treat.",
      long: "Delicious chocolate chip cookies, perfect for a sweet snack.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    description: {
      short: "Smarties cookies for a colorful snack.",
      long: "Colorful Smarties cookies, perfect for a fun and tasty treat.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    id: 83,
    name: "Éclair Caramel Beurre Salée",
    price: 19.0,
    fileName: "eclair-caramel-beurre-salee",
    slug: "eclair-caramel-beurre-salee",
    description: {
      short: "Salted caramel éclair for a decadent dessert.",
      long: "A decadent salted caramel éclair, perfect for dessert lovers.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    description: {
      short: "Chocolate éclair for a classic treat.",
      long: "A classic chocolate éclair, perfect for chocolate enthusiasts.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    description: {
      short: "Red fruit éclair for a fruity delight.",
      long: "A fruity éclair filled with red fruits, perfect for a sweet treat.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    slug: "eclair-vanille",
    description: {
      short: "Vanilla éclair for a creamy dessert.",
      long: "A creamy vanilla éclair, perfect for a light and sweet dessert.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  ...
  },
  {
    ...
    slug: "palmier-mini",
    description: {
      short: "Mini palmiers for a crispy snack.",
      long: "Crispy mini palmiers, perfect for a quick and tasty snack.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  ...
  },
  {
    ...
    description: {
      short: "Marble cake, 560g, for a classic dessert.",
      long: "A classic marble cake, weighing 560g, perfect for any occasion.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    name: "Cake Nat 560g",
    price: 46.0,
    fileName: "cake-nat-560g",
    slug: "cake-nat-560g",
    description: {
      short: "Natural cake, 560g, for a simple treat.",
      long: "A simple natural cake, weighing 560g, perfect for a light dessert.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    slug: "carre-caramel",
    description: {
      short: "Caramel square for a sweet treat.",
      long: "A sweet caramel square, perfect for a decadent dessert.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    description: {
      short: "Neutral mini square tart base.",
      long: "A neutral mini square tart base, perfect for small desserts.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    description: {
      short: "Neutral mini round tart base.",
      long: "A neutral mini round tart base, perfect for small desserts.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    slug: "chouquette",
    description: {
      short: "Chouquette for a light and airy snack.",
      long: "A light and airy chouquette, perfect for a quick snack.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  ...
  },
  {
    ...
    description: {
      short: "Pistachio and raspberry dessert for a unique flavor.",
      long: "A unique dessert combining pistachio and raspberry flavors.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  {
    ...
    description: {
      short: "Mini chocolate financier for a rich treat.",
      long: "A rich mini chocolate financier, perfect for a decadent snack.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  ...
  {
    id: 135,
    name: "Flute Olive Plus",
    price: 8.0,
    fileName: "flute-olive-plus",
    slug: "flute-olive-plus",
    description: {
      short: "Olive-infused flute for a Mediterranean flavor.",
      long: "A Mediterranean-inspired flute with olives, perfect for a rich taste.",
    },
    countInStock: 100,
    categoryId: 2,
  },
  ...
  {
    id: 138,
    name: "Big Flute Française",
    price: 3.6,
    fileName: "big-flute-francaise",
    slug: "big-flute-francaise",
    description: {
      short: "Large French flute for a hearty meal.",
      long: "A large French flute, perfect for a hearty and filling meal.",
    },
    countInStock: 100,
    categoryId: 2,
  },
